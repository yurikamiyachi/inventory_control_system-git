...
/**
 * Servlet implementation class InventoriesIndexServlet
 */
@WebServlet("/inventories/index")
public class InventoriesIndexServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public InventoriesIndexServlet() {
        super();
