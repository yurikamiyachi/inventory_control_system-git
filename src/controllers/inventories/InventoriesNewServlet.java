...
/**
 * Servlet implementation class InventoriesNewServlet
 */
@WebServlet("/inventories/new")
public class InventoriesNewServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public InventoriesNewServlet() {
        super();
